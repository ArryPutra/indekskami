...
class VPengelolaanAsetSheet implements FromView, WithTitle
{
    ...
    {
        $daftarPertanyaan = AreaEvaluasi::find(5)->pertanyaanEvaluasi;
        ...
        return view('exports.pertanyaan', [
            ...
            'title' => 'V Pengelolaan Aset',
        ]);
    }

    public function title(): string
    {
        return 'V Pengelolaan Aset';
    }
}
