...
<aside class="max-md:-left-[16rem] bg-slate-900 h-screen fixed max-md:w-[16rem]
    ...
    <div class="flex items-end h-20 max-h-20 mb-8 justify-between px-5">
        ...
        <svg @click="isOpen = false; localStorage.setItem('isOpenSidebar', false)" xmlns="http://www.w3.org/2000/svg"
            width="24" height="24" viewBox="0 0 24 24" class="size-12 fill-white mb-2 cursor-pointer"
            :class="{
                'md:hidden':
                    !isOpen
            }">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
        ...
        :class="{ 'md:hidden': isOpen }" @click="isOpen = true; localStorage.setItem('isOpenSidebar', true)">
