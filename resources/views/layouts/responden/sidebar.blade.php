...
<aside x-cloak x-data="{ isOpen: false }" class="bg-slate-900 h-screen fixed w-[16rem] z-20 duration-300 hidden"
    ...
    <div class="space-y-1.5">
        ...
        <a href="{{ route('admin.dashboard') }}"
            ...
            <svg class="size-6 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                <path
