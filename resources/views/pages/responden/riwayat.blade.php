...
@section('content')
    <x-table>
        ...
        <x-table.tbody>
            @if (count($daftarHasilEvaluasi) > 0)
                @foreach ($daftarHasilEvaluasi as $hasilEvaluasi)
                    <x-table.tr>
                        <x-table.td>
                            {{ $loop->iteration }}
                        </x-table.td>
                        ...
                        <x-table.td>
                            {{ $hasilEvaluasi->identitasResponden->pengisi_lembar_evaluasi }}
                        </x-table.td>
                        <x-table.td>
                        ...
                        <x-table.td>
                            {{ Carbon\Carbon::parse($hasilEvaluasi->created_at)->translatedFormat('l, d F Y, H:i:s') }}
                        </x-table.td>
                        <x-table.td>
                        ...
                        <x-table.td>
                            <div class="flex gap-2">
                                <x-button href="{{ route('responden.evaluasi.pertanyaan', [1, $hasilEvaluasi->id]) }}">
                                ...
                                <x-button
                                    href="{{ route('responden.evaluasi.dashboard.cetak-laporan', $hasilEvaluasi->id) }}"
                                    color="blue">
            ...
            @else
                <x-table.tr>
                    <x-table.td colspan="9" class="text-center">Data kosong!</x-table.td>
                </x-table.tr>
            @endif
        </x-table.tbody>
    </x-table>
