...
@section('content')
    ...
    <x-table>
        ...
        <x-table.tbody>
            @if ($daftarHasilEvaluasi->count() > 0)
                @foreach ($daftarHasilEvaluasi as $index => $hasilEvaluasi)
                    <x-table.tr>
                        ...
                        <x-table.td>{{ $hasilEvaluasi->verifikator->user->nama }}</x-table.td>
                        ...
                        <x-table.td>{{ Carbon\Carbon::parse($hasilEvaluasi->tanggal_diverifikasi)->translatedFormat('l, d F Y, H:i:s') }}</x-table.td>
                        <x-table.td>
            ...
            @else
                <x-table.tr>
                    <x-table.td colspan="10" class="text-center">Data kosong!</x-table.td>
                </x-table.tr>
            @endif
        </x-table.tbody>
    </x-table>
